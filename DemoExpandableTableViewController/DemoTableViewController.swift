...
class DemoTableViewController: ExpandableTableViewController, ExpandableTableViewDelegate, ExpandableTableViewDatasource {
    ...
    @IBAction func onDatePickerValueChanged(sender: UIDatePicker){
        ...
        var birthdateCell : BirthdateTableViewCell = tableView.cellForRowAtIndexPath(valueCellIndexPath) as! BirthdateTableViewCell
    ...
    func expandableTableView(expandableTableView: ExpandableTableView, cellForRowAtExpandableIndexPath expandableIndexPath: ExpandableIndexPath) -> UITableViewCell {
        ...
        case TableViewRows.Text.rawValue:
            var titleCell = expandableTableView.dequeueReusableCellWithIdentifier("TitleCell", forIndexPath: expandableIndexPath) as! TitleTableViewCell
    ...
    func expandableTableView(expandableTableView: ExpandableTableView, subCellForRowAtExpandableIndexPath expandableIndexPath: ExpandableIndexPath) -> UITableViewCell {
        ...
        switch(expandableIndexPath.row){
        case TableViewRows.Text.rawValue:
            var descriptionCell = expandableTableView.dequeueReusableCellWithIdentifier("DescriptionCell", forIndexPath: expandableIndexPath) as! DescriptionTableViewCell
        ...
        case TableViewRows.List.rawValue:
            var listTextCell = expandableTableView.dequeueReusableCellWithIdentifier("ListTextCell", forIndexPath: expandableIndexPath) as! ListTableViewCell
